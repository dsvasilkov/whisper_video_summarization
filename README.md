...
Проект поддерживает два способа настройки окружения: через Docker Compose (рекомендуется) или через Poetry локально.

#### Вариант 1: Установка через Docker Compose (рекомендуется)

Этот вариант не требует локальной установки зависимостей и обеспечивает изолированное окружение.
